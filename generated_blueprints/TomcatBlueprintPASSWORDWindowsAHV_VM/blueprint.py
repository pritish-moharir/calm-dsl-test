...
BP_CRED_TomcatPASSWORDCredential_PASSWORD = read_local_file(
    "BP_CRED_TomcatPASSWORDCredential_PASSWORD"
)

# Credentials
BP_CRED_TomcatPASSWORDCredential = basic_cred(
    "username",
    BP_CRED_TomcatPASSWORDCredential_PASSWORD,
    name="TomcatPASSWORDCredential",
    type="PASSWORD",
)
...
class TomcatService(Service):
    ...
    def __create__():
        ...
        CalmTask.Exec.escript.py2(
            ...
            filename=os.path.join(
                "scripts", "Service_TomcatService_Action___create___Task_Task_0.py"
            ),
        )
        ...
        CalmTask.Exec.escript.py2(
            name="Task_1",
            filename=os.path.join(
                "scripts", "Service_TomcatService_Action___create___Task_Task_1.py"
            ),
        )
        ...
        CalmTask.Exec.escript.py2(
            name="Task_2",
            filename=os.path.join(
                "scripts", "Service_TomcatService_Action___create___Task_Task_2.py"
            ),
        )
    ...
    def __delete__():
        ...
        CalmTask.Exec.escript.py2(
            name="Task_0",
            filename=os.path.join(
                "scripts", "Service_TomcatService_Action___delete___Task_Task_0.py"
            ),
        )
    ...
    def __start__():
        ...
        CalmTask.Exec.escript.py2(
            name="Task_0",
            filename=os.path.join(
                "scripts", "Service_TomcatService_Action___start___Task_Task_0.py"
            ),
        )
        ...
        CalmTask.Exec.escript.py2(
            name="Task_1",
            filename=os.path.join(
                "scripts", "Service_TomcatService_Action___start___Task_Task_1.py"
            ),
        )
    ...
    def __stop__():
        ...
        CalmTask.Exec.escript.py2(
            name="Task_0",
            filename=os.path.join(
                "scripts", "Service_TomcatService_Action___stop___Task_Task_0.py"
            ),
        )
        ...
        CalmTask.Exec.escript.py2(
            name="Task_1",
            filename=os.path.join(
                "scripts", "Service_TomcatService_Action___stop___Task_Task_1.py"
            ),
        )
    ...
    def __restart__():
        ...
        CalmTask.Exec.escript.py2(
            name="Task_0",
            filename=os.path.join(
                "scripts", "Service_TomcatService_Action___restart___Task_Task_0.py"
            ),
        )
        ...
        CalmTask.Exec.escript.py2(
            name="Task_1",
            filename=os.path.join(
                "scripts", "Service_TomcatService_Action___restart___Task_Task_1.py"
            ),
        )
        ...
        CalmTask.Exec.escript.py2(
            name="Task_2",
            filename=os.path.join(
                "scripts", "Service_TomcatService_Action___restart___Task_Task_2.py"
            ),
        )


class TomcatWindowsAHV_VMSubstrateVmResources(AhvVmResources):
...
class TomcatWindowsAHV_VMSubstrate(Substrate):
    """
    Substrate module for TomcatWindowsAHV_VM. It contains following vm-confugration:
        Disks count: 3
        Nics count: 3
        CdRom count: 1
    provider_spec:
    ...
    provider_spec = ahv_vm(
        ...
        resources=TomcatWindowsAHV_VMSubstrateVmResources,
    )
    ...
    readiness_probe = readiness_probe(
        ...
        address="@@{ip_address}@@",
        delay_secs="0",
        credential=ref(BP_CRED_TomcatPASSWORDCredential),
    )
    ...
    def __pre_create__():
        ...
        CalmTask.Exec.escript.py2(
            ...
            filename=os.path.join(
                "scripts",
                "Substrate_TomcatWindowsAHV_VMSubstrate_Action___pre_create___Task_Task_0.py",
            ),
        )
        ...
        CalmTask.Exec.escript.py2(
            ...
            filename=os.path.join(
                "scripts",
                "Substrate_TomcatWindowsAHV_VMSubstrate_Action___pre_create___Task_Task_1.py",
            ),
        )
        ...
        CalmTask.Exec.escript.py2(
            ...
            filename=os.path.join(
                "scripts",
                "Substrate_TomcatWindowsAHV_VMSubstrate_Action___pre_create___Task_Task_2.py",
            ),
        )
    ...
    def __post_delete__():
        ...
        CalmTask.Exec.escript.py2(
            ...
            filename=os.path.join(
                "scripts",
                "Substrate_TomcatWindowsAHV_VMSubstrate_Action___post_delete___Task_Task_0.py",
            ),
        )


class TomcatPackage(Package):
    """
    Package module for Tomcat
    Actions:
    ...
    def __install__():
        ...
        CalmTask.Exec.escript.py2(
            name="Task_0",
            filename=os.path.join(
                "scripts", "Package_TomcatPackage_Action___install___Task_Task_0.py"
            ),
        )
    ...
    def __uninstall__():
        ...
        CalmTask.Exec.escript.py2(
            name="Task_0",
            filename=os.path.join(
                "scripts", "Package_TomcatPackage_Action___uninstall___Task_Task_0.py"
            ),
        )
        ...
        CalmTask.Exec.escript.py2(
            name="Task_1",
            filename=os.path.join(
                "scripts", "Package_TomcatPackage_Action___uninstall___Task_Task_1.py"
            ),
        )


class TomcatDeployment(Deployment):
    """
    Deployment module for Tomcat.
    ...
    packages = [ref(TomcatPackage)]
    substrate = ref(TomcatWindowsAHV_VMSubstrate)


class TomcatProfile(Profile):
    """
    Profile module for Tomcat.
    ...
    deployments = [TomcatDeployment]


class TomcatBlueprint(Blueprint):
    """
    TomcatBlueprint module
    ...
    packages = [TomcatPackage]
    substrates = [TomcatWindowsAHV_VMSubstrate]
    profiles = [TomcatProfile]
    credentials = [BP_CRED_TomcatPASSWORDCredential]
