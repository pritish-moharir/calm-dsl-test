...
BP_CRED_CassandraKEYCredential_KEY = read_local_file(
    "BP_CRED_CassandraKEYCredential_KEY"
)

# Credentials
BP_CRED_CassandraKEYCredential = basic_cred(
    "username",
    BP_CRED_CassandraKEYCredential_KEY,
    name="CassandraKEYCredential",
    type="KEY",
)
...
class CassandraWindowsAHV_VMSubstrate(Substrate):
    ...
    readiness_probe = readiness_probe(
        ...
        address="@@{ip_address}@@",
        delay_secs="0",
        credential=ref(BP_CRED_CassandraKEYCredential),
    )
...
class CassandraBlueprint(Blueprint):
    ...
    credentials = [BP_CRED_CassandraKEYCredential]
