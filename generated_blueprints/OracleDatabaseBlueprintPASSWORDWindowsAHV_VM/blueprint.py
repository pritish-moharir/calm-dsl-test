...
BP_CRED_OracleDatabasePASSWORDCredential_PASSWORD = read_local_file(
    "BP_CRED_OracleDatabasePASSWORDCredential_PASSWORD"
)

# Credentials
BP_CRED_OracleDatabasePASSWORDCredential = basic_cred(
    "username",
    BP_CRED_OracleDatabasePASSWORDCredential_PASSWORD,
    name="OracleDatabasePASSWORDCredential",
    type="PASSWORD",
)


class OracleDatabaseService(Service):
    """
    OracleDatabaseService module
    Actions:
    ...
    def __create__():
        ...
        CalmTask.Exec.escript.py2(
            ...
            filename=os.path.join(
                "scripts",
                "Service_OracleDatabaseService_Action___create___Task_Task_0.py",
            ),
        )
        ...
        CalmTask.Exec.escript.py2(
            ...
            filename=os.path.join(
                "scripts",
                "Service_OracleDatabaseService_Action___create___Task_Task_1.py",
            ),
        )
        ...
        CalmTask.Exec.escript.py2(
            ...
            filename=os.path.join(
                "scripts",
                "Service_OracleDatabaseService_Action___create___Task_Task_2.py",
            ),
        )
    ...
    def __delete__():
        ...
        CalmTask.Exec.escript.py2(
            ...
            filename=os.path.join(
                "scripts",
                "Service_OracleDatabaseService_Action___delete___Task_Task_0.py",
            ),
        )
    ...
    def __start__():
        ...
        CalmTask.Exec.escript.py2(
            ...
            filename=os.path.join(
                "scripts",
                "Service_OracleDatabaseService_Action___start___Task_Task_0.py",
            ),
        )
        ...
        CalmTask.Exec.escript.py2(
            ...
            filename=os.path.join(
                "scripts",
                "Service_OracleDatabaseService_Action___start___Task_Task_1.py",
            ),
        )
    ...
    def __stop__():
        ...
        CalmTask.Exec.escript.py2(
            ...
            filename=os.path.join(
                "scripts",
                "Service_OracleDatabaseService_Action___stop___Task_Task_0.py",
            ),
        )
        ...
        CalmTask.Exec.escript.py2(
            ...
            filename=os.path.join(
                "scripts",
                "Service_OracleDatabaseService_Action___stop___Task_Task_1.py",
            ),
        )
    ...
    def __restart__():
        ...
        CalmTask.Exec.escript.py2(
            ...
            filename=os.path.join(
                "scripts",
                "Service_OracleDatabaseService_Action___restart___Task_Task_0.py",
            ),
        )
        ...
        CalmTask.Exec.escript.py2(
            ...
            filename=os.path.join(
                "scripts",
                "Service_OracleDatabaseService_Action___restart___Task_Task_1.py",
            ),
        )
        ...
        CalmTask.Exec.escript.py2(
            ...
            filename=os.path.join(
                "scripts",
                "Service_OracleDatabaseService_Action___restart___Task_Task_2.py",
            ),
        )


class OracleDatabaseWindowsAHV_VMSubstrateVmResources(AhvVmResources):
...
class OracleDatabaseWindowsAHV_VMSubstrate(Substrate):
    """
    Substrate module for OracleDatabaseWindowsAHV_VM. It contains following vm-confugration:
        Disks count: 3
        Nics count: 3
        CdRom count: 1
    provider_spec:
    ...
    provider_spec = ahv_vm(
        ...
        resources=OracleDatabaseWindowsAHV_VMSubstrateVmResources,
    )
    ...
    readiness_probe = readiness_probe(
        ...
        address="@@{ip_address}@@",
        delay_secs="0",
        credential=ref(BP_CRED_OracleDatabasePASSWORDCredential),
    )
    ...
    def __pre_create__():
        ...
        CalmTask.Exec.escript.py2(
            ...
            filename=os.path.join(
                "scripts",
                "Substrate_OracleDatabaseWindowsAHV_VMSubstrate_Action___pre_create___Task_Task_0.py",
            ),
        )
        ...
        CalmTask.Exec.escript.py2(
            ...
            filename=os.path.join(
                "scripts",
                "Substrate_OracleDatabaseWindowsAHV_VMSubstrate_Action___pre_create___Task_Task_1.py",
            ),
        )
        ...
        CalmTask.Exec.escript.py2(
            ...
            filename=os.path.join(
                "scripts",
                "Substrate_OracleDatabaseWindowsAHV_VMSubstrate_Action___pre_create___Task_Task_2.py",
            ),
        )
    ...
    def __post_delete__():
        ...
        CalmTask.Exec.escript.py2(
            ...
            filename=os.path.join(
                "scripts",
                "Substrate_OracleDatabaseWindowsAHV_VMSubstrate_Action___post_delete___Task_Task_0.py",
            ),
        )


class OracleDatabasePackage(Package):
    """
    Package module for OracleDatabase
    Actions:
    ...
    services = [ref(OracleDatabaseService)]
    ...
    def __install__():
        ...
        CalmTask.Exec.escript.py2(
            ...
            filename=os.path.join(
                "scripts",
                "Package_OracleDatabasePackage_Action___install___Task_Task_0.py",
            ),
        )
    ...
    def __uninstall__():
        ...
        CalmTask.Exec.escript.py2(
            ...
            filename=os.path.join(
                "scripts",
                "Package_OracleDatabasePackage_Action___uninstall___Task_Task_0.py",
            ),
        )
        ...
        CalmTask.Exec.escript.py2(
            ...
            filename=os.path.join(
                "scripts",
                "Package_OracleDatabasePackage_Action___uninstall___Task_Task_1.py",
            ),
        )


class OracleDatabaseDeployment(Deployment):
    """
    Deployment module for OracleDatabase.
    ...
    packages = [ref(OracleDatabasePackage)]
    substrate = ref(OracleDatabaseWindowsAHV_VMSubstrate)


class OracleDatabaseProfile(Profile):
    """
    Profile module for OracleDatabase.
    ...
    deployments = [OracleDatabaseDeployment]


class OracleDatabaseBlueprint(Blueprint):
    """
    OracleDatabaseBlueprint module
    ...
    services = [OracleDatabaseService]
    packages = [OracleDatabasePackage]
    substrates = [OracleDatabaseWindowsAHV_VMSubstrate]
    profiles = [OracleDatabaseProfile]
    credentials = [BP_CRED_OracleDatabasePASSWORDCredential]
