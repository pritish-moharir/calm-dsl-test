...
BP_CRED_MicrosoftNETCorePASSWORDCredential_PASSWORD = read_local_file(
    "BP_CRED_MicrosoftNETCorePASSWORDCredential_PASSWORD"
)

# Credentials
BP_CRED_MicrosoftNETCorePASSWORDCredential = basic_cred(
    "username",
    BP_CRED_MicrosoftNETCorePASSWORDCredential_PASSWORD,
    name="MicrosoftNETCorePASSWORDCredential",
    type="PASSWORD",
)


class MicrosoftNETCoreService(Service):
    """
    MicrosoftNETCoreService module
    Actions:
    ...
    def __create__():
        ...
        CalmTask.Exec.escript.py2(
            ...
            filename=os.path.join(
                "scripts",
                "Service_MicrosoftNETCoreService_Action___create___Task_Task_0.py",
            ),
        )
        ...
        CalmTask.Exec.escript.py2(
            ...
            filename=os.path.join(
                "scripts",
                "Service_MicrosoftNETCoreService_Action___create___Task_Task_1.py",
            ),
        )
        ...
        CalmTask.Exec.escript.py2(
            ...
            filename=os.path.join(
                "scripts",
                "Service_MicrosoftNETCoreService_Action___create___Task_Task_2.py",
            ),
        )
    ...
    def __delete__():
        ...
        CalmTask.Exec.escript.py2(
            ...
            filename=os.path.join(
                "scripts",
                "Service_MicrosoftNETCoreService_Action___delete___Task_Task_0.py",
            ),
        )
    ...
    def __start__():
        ...
        CalmTask.Exec.escript.py2(
            ...
            filename=os.path.join(
                "scripts",
                "Service_MicrosoftNETCoreService_Action___start___Task_Task_0.py",
            ),
        )
        ...
        CalmTask.Exec.escript.py2(
            ...
            filename=os.path.join(
                "scripts",
                "Service_MicrosoftNETCoreService_Action___start___Task_Task_1.py",
            ),
        )
    ...
    def __stop__():
        ...
        CalmTask.Exec.escript.py2(
            ...
            filename=os.path.join(
                "scripts",
                "Service_MicrosoftNETCoreService_Action___stop___Task_Task_0.py",
            ),
        )
        ...
        CalmTask.Exec.escript.py2(
            ...
            filename=os.path.join(
                "scripts",
                "Service_MicrosoftNETCoreService_Action___stop___Task_Task_1.py",
            ),
        )
    ...
    def __restart__():
        ...
        CalmTask.Exec.escript.py2(
            ...
            filename=os.path.join(
                "scripts",
                "Service_MicrosoftNETCoreService_Action___restart___Task_Task_0.py",
            ),
        )
        ...
        CalmTask.Exec.escript.py2(
            ...
            filename=os.path.join(
                "scripts",
                "Service_MicrosoftNETCoreService_Action___restart___Task_Task_1.py",
            ),
        )
        ...
        CalmTask.Exec.escript.py2(
            ...
            filename=os.path.join(
                "scripts",
                "Service_MicrosoftNETCoreService_Action___restart___Task_Task_2.py",
            ),
        )


class MicrosoftNETCoreWindowsAHV_VMSubstrateVmResources(AhvVmResources):
...
class MicrosoftNETCoreWindowsAHV_VMSubstrate(Substrate):
    """
    Substrate module for MicrosoftNETCoreWindowsAHV_VM. It contains following vm-confugration:
        Disks count: 3
        Nics count: 3
        CdRom count: 1
    provider_spec:
    ...
    provider_spec = ahv_vm(
        ...
        resources=MicrosoftNETCoreWindowsAHV_VMSubstrateVmResources,
    )
    ...
    readiness_probe = readiness_probe(
        ...
        address="@@{ip_address}@@",
        delay_secs="0",
        credential=ref(BP_CRED_MicrosoftNETCorePASSWORDCredential),
    )
    ...
    def __pre_create__():
        ...
        CalmTask.Exec.escript.py2(
            ...
            filename=os.path.join(
                "scripts",
                "Substrate_MicrosoftNETCoreWindowsAHV_VMSubstrate_Action___pre_create___Task_Task_0.py",
            ),
        )
        ...
        CalmTask.Exec.escript.py2(
            ...
            filename=os.path.join(
                "scripts",
                "Substrate_MicrosoftNETCoreWindowsAHV_VMSubstrate_Action___pre_create___Task_Task_1.py",
            ),
        )
        ...
        CalmTask.Exec.escript.py2(
            ...
            filename=os.path.join(
                "scripts",
                "Substrate_MicrosoftNETCoreWindowsAHV_VMSubstrate_Action___pre_create___Task_Task_2.py",
            ),
        )
    ...
    def __post_delete__():
        ...
        CalmTask.Exec.escript.py2(
            ...
            filename=os.path.join(
                "scripts",
                "Substrate_MicrosoftNETCoreWindowsAHV_VMSubstrate_Action___post_delete___Task_Task_0.py",
            ),
        )


class MicrosoftNETCorePackage(Package):
    """
    Package module for MicrosoftNETCore
    Actions:
    ...
    services = [ref(MicrosoftNETCoreService)]
    ...
    def __install__():
        ...
        CalmTask.Exec.escript.py2(
            ...
            filename=os.path.join(
                "scripts",
                "Package_MicrosoftNETCorePackage_Action___install___Task_Task_0.py",
            ),
        )
    ...
    def __uninstall__():
        ...
        CalmTask.Exec.escript.py2(
            ...
            filename=os.path.join(
                "scripts",
                "Package_MicrosoftNETCorePackage_Action___uninstall___Task_Task_0.py",
            ),
        )
        ...
        CalmTask.Exec.escript.py2(
            ...
            filename=os.path.join(
                "scripts",
                "Package_MicrosoftNETCorePackage_Action___uninstall___Task_Task_1.py",
            ),
        )


class MicrosoftNETCoreDeployment(Deployment):
    """
    Deployment module for MicrosoftNETCore.
    ...
    packages = [ref(MicrosoftNETCorePackage)]
    substrate = ref(MicrosoftNETCoreWindowsAHV_VMSubstrate)


class MicrosoftNETCoreProfile(Profile):
    """
    Profile module for MicrosoftNETCore.
    ...
    deployments = [MicrosoftNETCoreDeployment]


class MicrosoftNETCoreBlueprint(Blueprint):
    """
    MicrosoftNETCoreBlueprint module
    ...
    services = [MicrosoftNETCoreService]
    packages = [MicrosoftNETCorePackage]
    substrates = [MicrosoftNETCoreWindowsAHV_VMSubstrate]
    profiles = [MicrosoftNETCoreProfile]
    credentials = [BP_CRED_MicrosoftNETCorePASSWORDCredential]
