...
BP_CRED_DockerKEYCredential_KEY = read_local_file("BP_CRED_DockerKEYCredential_KEY")

# Credentials
BP_CRED_DockerKEYCredential = basic_cred(
    "username",
    BP_CRED_DockerKEYCredential_KEY,
    name="DockerKEYCredential",
    type="KEY",
)
...
class DockerLinuxAHV_VMSubstrateVmResources(AhvVmResources):
...
class DockerLinuxAHV_VMSubstrate(Substrate):
    """
    Substrate module for DockerLinuxAHV_VM. It contains following vm-confugration:
        Disks count: 3
        Nics count: 3
        CdRom count: 1
    provider_spec:
    ...
    provider_spec = ahv_vm(
        ...
        resources=DockerLinuxAHV_VMSubstrateVmResources,
    )
    ...
    readiness_probe = readiness_probe(
        ...
        address="@@{ip_address}@@",
        delay_secs="0",
        credential=ref(BP_CRED_DockerKEYCredential),
    )
    ...
    def __pre_create__():
        ...
        CalmTask.Exec.escript.py2(
            ...
            filename=os.path.join(
                "scripts",
                "Substrate_DockerLinuxAHV_VMSubstrate_Action___pre_create___Task_Task_0.py",
            ),
        )
        ...
        CalmTask.Exec.escript.py2(
            ...
            filename=os.path.join(
                "scripts",
                "Substrate_DockerLinuxAHV_VMSubstrate_Action___pre_create___Task_Task_1.py",
            ),
        )
        ...
        CalmTask.Exec.escript.py2(
            ...
            filename=os.path.join(
                "scripts",
                "Substrate_DockerLinuxAHV_VMSubstrate_Action___pre_create___Task_Task_2.py",
            ),
        )
    ...
    def __post_delete__():
        ...
        CalmTask.Exec.escript.py2(
            ...
            filename=os.path.join(
                "scripts",
                "Substrate_DockerLinuxAHV_VMSubstrate_Action___post_delete___Task_Task_0.py",
            ),
        )
...
class DockerDeployment(Deployment):
    ...
    substrate = ref(DockerLinuxAHV_VMSubstrate)
...
class DockerBlueprint(Blueprint):
    ...
    substrates = [DockerLinuxAHV_VMSubstrate]
    profiles = [DockerProfile]
    credentials = [BP_CRED_DockerKEYCredential]
