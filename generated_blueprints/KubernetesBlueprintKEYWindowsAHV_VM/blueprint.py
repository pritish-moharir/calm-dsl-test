...
BP_CRED_KubernetesKEYCredential_KEY = read_local_file(
    "BP_CRED_KubernetesKEYCredential_KEY"
)

# Credentials
BP_CRED_KubernetesKEYCredential = basic_cred(
    "username",
    BP_CRED_KubernetesKEYCredential_KEY,
    name="KubernetesKEYCredential",
    type="KEY",
)
...
class KubernetesWindowsAHV_VMSubstrate(Substrate):
    ...
    readiness_probe = readiness_probe(
        ...
        address="@@{ip_address}@@",
        delay_secs="0",
        credential=ref(BP_CRED_KubernetesKEYCredential),
    )
...
class KubernetesBlueprint(Blueprint):
    ...
    credentials = [BP_CRED_KubernetesKEYCredential]
