...
class ApacheHTTPServerLinuxAHV_VMSubstrateVmResources(AhvVmResources):
...
class ApacheHTTPServerLinuxAHV_VMSubstrate(Substrate):
    """
    Substrate module for ApacheHTTPServerLinuxAHV_VM. It contains following vm-confugration:
        Disks count: 3
        Nics count: 3
        CdRom count: 1
    provider_spec:
    ...
    provider_spec = ahv_vm(
        ...
        resources=ApacheHTTPServerLinuxAHV_VMSubstrateVmResources,
    )
    ...
    def __pre_create__():
        ...
        CalmTask.Exec.escript.py2(
            ...
            filename=os.path.join(
                "scripts",
                "Substrate_ApacheHTTPServerLinuxAHV_VMSubstrate_Action___pre_create___Task_Task_0.py",
            ),
        )
        ...
        CalmTask.Exec.escript.py2(
            ...
            filename=os.path.join(
                "scripts",
                "Substrate_ApacheHTTPServerLinuxAHV_VMSubstrate_Action___pre_create___Task_Task_1.py",
            ),
        )
        ...
        CalmTask.Exec.escript.py2(
            ...
            filename=os.path.join(
                "scripts",
                "Substrate_ApacheHTTPServerLinuxAHV_VMSubstrate_Action___pre_create___Task_Task_2.py",
            ),
        )
    ...
    def __post_delete__():
        ...
        CalmTask.Exec.escript.py2(
            ...
            filename=os.path.join(
                "scripts",
                "Substrate_ApacheHTTPServerLinuxAHV_VMSubstrate_Action___post_delete___Task_Task_0.py",
            ),
        )
...
class ApacheHTTPServerDeployment(Deployment):
    ...
    substrate = ref(ApacheHTTPServerLinuxAHV_VMSubstrate)
...
class ApacheHTTPServerBlueprint(Blueprint):
    ...
    substrates = [ApacheHTTPServerLinuxAHV_VMSubstrate]
