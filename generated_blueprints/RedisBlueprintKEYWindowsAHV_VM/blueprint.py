...
BP_CRED_RedisKEYCredential_KEY = read_local_file("BP_CRED_RedisKEYCredential_KEY")

# Credentials
BP_CRED_RedisKEYCredential = basic_cred(
    "username",
    BP_CRED_RedisKEYCredential_KEY,
    name="RedisKEYCredential",
    type="KEY",
)
...
class RedisWindowsAHV_VMSubstrate(Substrate):
    ...
    readiness_probe = readiness_probe(
        ...
        address="@@{ip_address}@@",
        delay_secs="0",
        credential=ref(BP_CRED_RedisKEYCredential),
    )
...
class RedisBlueprint(Blueprint):
    ...
    credentials = [BP_CRED_RedisKEYCredential]
