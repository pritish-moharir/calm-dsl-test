...
BP_CRED_MongoDBKEYCredential_KEY = read_local_file("BP_CRED_MongoDBKEYCredential_KEY")

# Credentials
BP_CRED_MongoDBKEYCredential = basic_cred(
    "username",
    BP_CRED_MongoDBKEYCredential_KEY,
    name="MongoDBKEYCredential",
    type="KEY",
)
...
class MongoDBLinuxAHV_VMSubstrateVmResources(AhvVmResources):
...
class MongoDBLinuxAHV_VMSubstrate(Substrate):
    """
    Substrate module for MongoDBLinuxAHV_VM. It contains following vm-confugration:
        Disks count: 3
        Nics count: 3
        CdRom count: 1
    provider_spec:
    ...
    provider_spec = ahv_vm(
        ...
        resources=MongoDBLinuxAHV_VMSubstrateVmResources,
    )
    ...
    readiness_probe = readiness_probe(
        ...
        address="@@{ip_address}@@",
        delay_secs="0",
        credential=ref(BP_CRED_MongoDBKEYCredential),
    )
    ...
    def __pre_create__():
        ...
        CalmTask.Exec.escript.py2(
            ...
            filename=os.path.join(
                "scripts",
                "Substrate_MongoDBLinuxAHV_VMSubstrate_Action___pre_create___Task_Task_0.py",
            ),
        )
        ...
        CalmTask.Exec.escript.py2(
            ...
            filename=os.path.join(
                "scripts",
                "Substrate_MongoDBLinuxAHV_VMSubstrate_Action___pre_create___Task_Task_1.py",
            ),
        )
        ...
        CalmTask.Exec.escript.py2(
            ...
            filename=os.path.join(
                "scripts",
                "Substrate_MongoDBLinuxAHV_VMSubstrate_Action___pre_create___Task_Task_2.py",
            ),
        )
    ...
    def __post_delete__():
        ...
        CalmTask.Exec.escript.py2(
            ...
            filename=os.path.join(
                "scripts",
                "Substrate_MongoDBLinuxAHV_VMSubstrate_Action___post_delete___Task_Task_0.py",
            ),
        )
...
class MongoDBDeployment(Deployment):
    ...
    substrate = ref(MongoDBLinuxAHV_VMSubstrate)
...
class MongoDBBlueprint(Blueprint):
    ...
    substrates = [MongoDBLinuxAHV_VMSubstrate]
    profiles = [MongoDBProfile]
    credentials = [BP_CRED_MongoDBKEYCredential]
