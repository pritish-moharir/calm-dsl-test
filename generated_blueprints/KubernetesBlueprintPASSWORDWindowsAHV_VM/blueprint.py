...
BP_CRED_KubernetesPASSWORDCredential_PASSWORD = read_local_file(
    "BP_CRED_KubernetesPASSWORDCredential_PASSWORD"
)

# Credentials
BP_CRED_KubernetesPASSWORDCredential = basic_cred(
    "username",
    BP_CRED_KubernetesPASSWORDCredential_PASSWORD,
    name="KubernetesPASSWORDCredential",
    type="PASSWORD",
)
...
class KubernetesService(Service):
    ...
    def __create__():
        ...
        CalmTask.Exec.escript.py2(
            ...
            filename=os.path.join(
                "scripts", "Service_KubernetesService_Action___create___Task_Task_0.py"
            ),
        )
        ...
        CalmTask.Exec.escript.py2(
            name="Task_1",
            filename=os.path.join(
                "scripts", "Service_KubernetesService_Action___create___Task_Task_1.py"
            ),
        )
        ...
        CalmTask.Exec.escript.py2(
            name="Task_2",
            filename=os.path.join(
                "scripts", "Service_KubernetesService_Action___create___Task_Task_2.py"
            ),
        )
    ...
    def __delete__():
        ...
        CalmTask.Exec.escript.py2(
            name="Task_0",
            filename=os.path.join(
                "scripts", "Service_KubernetesService_Action___delete___Task_Task_0.py"
            ),
        )
    ...
    def __start__():
        ...
        CalmTask.Exec.escript.py2(
            name="Task_0",
            filename=os.path.join(
                "scripts", "Service_KubernetesService_Action___start___Task_Task_0.py"
            ),
        )
        ...
        CalmTask.Exec.escript.py2(
            name="Task_1",
            filename=os.path.join(
                "scripts", "Service_KubernetesService_Action___start___Task_Task_1.py"
            ),
        )
    ...
    def __stop__():
        ...
        CalmTask.Exec.escript.py2(
            name="Task_0",
            filename=os.path.join(
                "scripts", "Service_KubernetesService_Action___stop___Task_Task_0.py"
            ),
        )
        ...
        CalmTask.Exec.escript.py2(
            name="Task_1",
            filename=os.path.join(
                "scripts", "Service_KubernetesService_Action___stop___Task_Task_1.py"
            ),
        )
    ...
    def __restart__():
        ...
        CalmTask.Exec.escript.py2(
            name="Task_0",
            filename=os.path.join(
                "scripts", "Service_KubernetesService_Action___restart___Task_Task_0.py"
            ),
        )
        ...
        CalmTask.Exec.escript.py2(
            name="Task_1",
            filename=os.path.join(
                "scripts", "Service_KubernetesService_Action___restart___Task_Task_1.py"
            ),
        )
        ...
        CalmTask.Exec.escript.py2(
            name="Task_2",
            filename=os.path.join(
                "scripts", "Service_KubernetesService_Action___restart___Task_Task_2.py"
            ),
        )


class KubernetesWindowsAHV_VMSubstrateVmResources(AhvVmResources):
...
class KubernetesWindowsAHV_VMSubstrate(Substrate):
    """
    Substrate module for KubernetesWindowsAHV_VM. It contains following vm-confugration:
        Disks count: 3
        Nics count: 3
        CdRom count: 1
    provider_spec:
    ...
    provider_spec = ahv_vm(
        ...
        resources=KubernetesWindowsAHV_VMSubstrateVmResources,
    )
    ...
    readiness_probe = readiness_probe(
        ...
        address="@@{ip_address}@@",
        delay_secs="0",
        credential=ref(BP_CRED_KubernetesPASSWORDCredential),
    )
    ...
    def __pre_create__():
        ...
        CalmTask.Exec.escript.py2(
            ...
            filename=os.path.join(
                "scripts",
                "Substrate_KubernetesWindowsAHV_VMSubstrate_Action___pre_create___Task_Task_0.py",
            ),
        )
        ...
        CalmTask.Exec.escript.py2(
            ...
            filename=os.path.join(
                "scripts",
                "Substrate_KubernetesWindowsAHV_VMSubstrate_Action___pre_create___Task_Task_1.py",
            ),
        )
        ...
        CalmTask.Exec.escript.py2(
            ...
            filename=os.path.join(
                "scripts",
                "Substrate_KubernetesWindowsAHV_VMSubstrate_Action___pre_create___Task_Task_2.py",
            ),
        )
    ...
    def __post_delete__():
        ...
        CalmTask.Exec.escript.py2(
            ...
            filename=os.path.join(
                "scripts",
                "Substrate_KubernetesWindowsAHV_VMSubstrate_Action___post_delete___Task_Task_0.py",
            ),
        )


class KubernetesPackage(Package):
    """
    Package module for Kubernetes
    Actions:
    ...
    services = [ref(KubernetesService)]
    ...
    def __install__():
        ...
        CalmTask.Exec.escript.py2(
            name="Task_0",
            filename=os.path.join(
                "scripts", "Package_KubernetesPackage_Action___install___Task_Task_0.py"
            ),
        )
    ...
    def __uninstall__():
        ...
        CalmTask.Exec.escript.py2(
            ...
            filename=os.path.join(
                "scripts",
                "Package_KubernetesPackage_Action___uninstall___Task_Task_0.py",
            ),
        )
        ...
        CalmTask.Exec.escript.py2(
            ...
            filename=os.path.join(
                "scripts",
                "Package_KubernetesPackage_Action___uninstall___Task_Task_1.py",
            ),
        )
...
class KubernetesDeployment(Deployment):
    """
    Deployment module for Kubernetes.
    ...
    packages = [ref(KubernetesPackage)]
    substrate = ref(KubernetesWindowsAHV_VMSubstrate)


class KubernetesProfile(Profile):
    """
    Profile module for Kubernetes.
...
class KubernetesBlueprint(Blueprint):
    """
    KubernetesBlueprint module
    ...
    substrates = [KubernetesWindowsAHV_VMSubstrate]
    profiles = [KubernetesProfile]
    credentials = [BP_CRED_KubernetesPASSWORDCredential]
