...
BP_CRED_PrometheusPASSWORDCredential_PASSWORD = read_local_file(
    "BP_CRED_PrometheusPASSWORDCredential_PASSWORD"
)

# Credentials
BP_CRED_PrometheusPASSWORDCredential = basic_cred(
    "username",
    BP_CRED_PrometheusPASSWORDCredential_PASSWORD,
    name="PrometheusPASSWORDCredential",
    type="PASSWORD",
)
...
class PrometheusService(Service):
    ...
    def __create__():
        ...
        CalmTask.Exec.escript.py2(
            ...
            filename=os.path.join(
                "scripts", "Service_PrometheusService_Action___create___Task_Task_0.py"
            ),
        )
        ...
        CalmTask.Exec.escript.py2(
            name="Task_1",
            filename=os.path.join(
                "scripts", "Service_PrometheusService_Action___create___Task_Task_1.py"
            ),
        )
        ...
        CalmTask.Exec.escript.py2(
            name="Task_2",
            filename=os.path.join(
                "scripts", "Service_PrometheusService_Action___create___Task_Task_2.py"
            ),
        )
    ...
    def __delete__():
        ...
        CalmTask.Exec.escript.py2(
            name="Task_0",
            filename=os.path.join(
                "scripts", "Service_PrometheusService_Action___delete___Task_Task_0.py"
            ),
        )
    ...
    def __start__():
        ...
        CalmTask.Exec.escript.py2(
            name="Task_0",
            filename=os.path.join(
                "scripts", "Service_PrometheusService_Action___start___Task_Task_0.py"
            ),
        )
        ...
        CalmTask.Exec.escript.py2(
            name="Task_1",
            filename=os.path.join(
                "scripts", "Service_PrometheusService_Action___start___Task_Task_1.py"
            ),
        )
    ...
    def __stop__():
        ...
        CalmTask.Exec.escript.py2(
            name="Task_0",
            filename=os.path.join(
                "scripts", "Service_PrometheusService_Action___stop___Task_Task_0.py"
            ),
        )
        ...
        CalmTask.Exec.escript.py2(
            name="Task_1",
            filename=os.path.join(
                "scripts", "Service_PrometheusService_Action___stop___Task_Task_1.py"
            ),
        )
    ...
    def __restart__():
        ...
        CalmTask.Exec.escript.py2(
            name="Task_0",
            filename=os.path.join(
                "scripts", "Service_PrometheusService_Action___restart___Task_Task_0.py"
            ),
        )
        ...
        CalmTask.Exec.escript.py2(
            name="Task_1",
            filename=os.path.join(
                "scripts", "Service_PrometheusService_Action___restart___Task_Task_1.py"
            ),
        )
        ...
        CalmTask.Exec.escript.py2(
            name="Task_2",
            filename=os.path.join(
                "scripts", "Service_PrometheusService_Action___restart___Task_Task_2.py"
            ),
        )


class PrometheusWindowsAHV_VMSubstrateVmResources(AhvVmResources):
...
class PrometheusWindowsAHV_VMSubstrate(Substrate):
    """
    Substrate module for PrometheusWindowsAHV_VM. It contains following vm-confugration:
        Disks count: 3
        Nics count: 3
        CdRom count: 1
    provider_spec:
    ...
    provider_spec = ahv_vm(
        ...
        resources=PrometheusWindowsAHV_VMSubstrateVmResources,
    )
    ...
    readiness_probe = readiness_probe(
        ...
        address="@@{ip_address}@@",
        delay_secs="0",
        credential=ref(BP_CRED_PrometheusPASSWORDCredential),
    )
    ...
    def __pre_create__():
        ...
        CalmTask.Exec.escript.py2(
            ...
            filename=os.path.join(
                "scripts",
                "Substrate_PrometheusWindowsAHV_VMSubstrate_Action___pre_create___Task_Task_0.py",
            ),
        )
        ...
        CalmTask.Exec.escript.py2(
            ...
            filename=os.path.join(
                "scripts",
                "Substrate_PrometheusWindowsAHV_VMSubstrate_Action___pre_create___Task_Task_1.py",
            ),
        )
        ...
        CalmTask.Exec.escript.py2(
            ...
            filename=os.path.join(
                "scripts",
                "Substrate_PrometheusWindowsAHV_VMSubstrate_Action___pre_create___Task_Task_2.py",
            ),
        )
    ...
    def __post_delete__():
        ...
        CalmTask.Exec.escript.py2(
            ...
            filename=os.path.join(
                "scripts",
                "Substrate_PrometheusWindowsAHV_VMSubstrate_Action___post_delete___Task_Task_0.py",
            ),
        )


class PrometheusPackage(Package):
    """
    Package module for Prometheus
    Actions:
    ...
    services = [ref(PrometheusService)]
    ...
    def __install__():
        ...
        CalmTask.Exec.escript.py2(
            name="Task_0",
            filename=os.path.join(
                "scripts", "Package_PrometheusPackage_Action___install___Task_Task_0.py"
            ),
        )
    ...
    def __uninstall__():
        ...
        CalmTask.Exec.escript.py2(
            ...
            filename=os.path.join(
                "scripts",
                "Package_PrometheusPackage_Action___uninstall___Task_Task_0.py",
            ),
        )
        ...
        CalmTask.Exec.escript.py2(
            ...
            filename=os.path.join(
                "scripts",
                "Package_PrometheusPackage_Action___uninstall___Task_Task_1.py",
            ),
        )
...
class PrometheusDeployment(Deployment):
    """
    Deployment module for Prometheus.
    ...
    packages = [ref(PrometheusPackage)]
    substrate = ref(PrometheusWindowsAHV_VMSubstrate)


class PrometheusProfile(Profile):
    """
    Profile module for Prometheus.
    ...
    deployments = [PrometheusDeployment]


class PrometheusBlueprint(Blueprint):
    """
    PrometheusBlueprint module
    ...
    packages = [PrometheusPackage]
    substrates = [PrometheusWindowsAHV_VMSubstrate]
    profiles = [PrometheusProfile]
    credentials = [BP_CRED_PrometheusPASSWORDCredential]
