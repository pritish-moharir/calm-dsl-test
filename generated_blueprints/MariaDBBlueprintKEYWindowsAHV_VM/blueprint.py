...
BP_CRED_MariaDBKEYCredential_KEY = read_local_file("BP_CRED_MariaDBKEYCredential_KEY")

# Credentials
BP_CRED_MariaDBKEYCredential = basic_cred(
    "username",
    BP_CRED_MariaDBKEYCredential_KEY,
    name="MariaDBKEYCredential",
    type="KEY",
)
...
class MariaDBWindowsAHV_VMSubstrate(Substrate):
    ...
    readiness_probe = readiness_probe(
        ...
        address="@@{ip_address}@@",
        delay_secs="0",
        credential=ref(BP_CRED_MariaDBKEYCredential),
    )
...
class MariaDBBlueprint(Blueprint):
    ...
    credentials = [BP_CRED_MariaDBKEYCredential]
