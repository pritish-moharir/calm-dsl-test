...
BP_CRED_WordPressKEYCredential_KEY = read_local_file(
    "BP_CRED_WordPressKEYCredential_KEY"
)

# Credentials
BP_CRED_WordPressKEYCredential = basic_cred(
    "username",
    BP_CRED_WordPressKEYCredential_KEY,
    name="WordPressKEYCredential",
    type="KEY",
)
...
class WordPressWindowsAHV_VMSubstrate(Substrate):
    ...
    readiness_probe = readiness_probe(
        ...
        address="@@{ip_address}@@",
        delay_secs="0",
        credential=ref(BP_CRED_WordPressKEYCredential),
    )
...
class WordPressBlueprint(Blueprint):
    ...
    credentials = [BP_CRED_WordPressKEYCredential]
