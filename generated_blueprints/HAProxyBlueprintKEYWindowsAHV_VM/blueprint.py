...
BP_CRED_HAProxyKEYCredential_KEY = read_local_file("BP_CRED_HAProxyKEYCredential_KEY")

# Credentials
BP_CRED_HAProxyKEYCredential = basic_cred(
    "username",
    BP_CRED_HAProxyKEYCredential_KEY,
    name="HAProxyKEYCredential",
    type="KEY",
)
...
class HAProxyWindowsAHV_VMSubstrate(Substrate):
    ...
    readiness_probe = readiness_probe(
        ...
        address="@@{ip_address}@@",
        delay_secs="0",
        credential=ref(BP_CRED_HAProxyKEYCredential),
    )
...
class HAProxyBlueprint(Blueprint):
    ...
    credentials = [BP_CRED_HAProxyKEYCredential]
