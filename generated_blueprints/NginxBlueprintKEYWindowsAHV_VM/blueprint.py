...
BP_CRED_NginxKEYCredential_KEY = read_local_file("BP_CRED_NginxKEYCredential_KEY")

# Credentials
BP_CRED_NginxKEYCredential = basic_cred(
    "username",
    BP_CRED_NginxKEYCredential_KEY,
    name="NginxKEYCredential",
    type="KEY",
)
...
class NginxWindowsAHV_VMSubstrate(Substrate):
    ...
    readiness_probe = readiness_probe(
        ...
        address="@@{ip_address}@@",
        delay_secs="0",
        credential=ref(BP_CRED_NginxKEYCredential),
    )
...
class NginxBlueprint(Blueprint):
    ...
    credentials = [BP_CRED_NginxKEYCredential]
