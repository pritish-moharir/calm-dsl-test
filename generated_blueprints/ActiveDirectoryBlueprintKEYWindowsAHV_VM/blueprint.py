...
BP_CRED_ActiveDirectoryKEYCredential_KEY = read_local_file(
    "BP_CRED_ActiveDirectoryKEYCredential_KEY"
)

# Credentials
BP_CRED_ActiveDirectoryKEYCredential = basic_cred(
    "username",
    BP_CRED_ActiveDirectoryKEYCredential_KEY,
    name="ActiveDirectoryKEYCredential",
    type="KEY",
)
...
class ActiveDirectoryWindowsAHV_VMSubstrate(Substrate):
    ...
    readiness_probe = readiness_probe(
        ...
        address="@@{ip_address}@@",
        delay_secs="0",
        credential=ref(BP_CRED_ActiveDirectoryKEYCredential),
    )
...
class ActiveDirectoryBlueprint(Blueprint):
    ...
    credentials = [BP_CRED_ActiveDirectoryKEYCredential]
