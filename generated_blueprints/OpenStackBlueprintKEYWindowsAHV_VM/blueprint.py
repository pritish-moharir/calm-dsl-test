...
BP_CRED_OpenStackKEYCredential_KEY = read_local_file(
    "BP_CRED_OpenStackKEYCredential_KEY"
)

# Credentials
BP_CRED_OpenStackKEYCredential = basic_cred(
    "username",
    BP_CRED_OpenStackKEYCredential_KEY,
    name="OpenStackKEYCredential",
    type="KEY",
)
...
class OpenStackWindowsAHV_VMSubstrate(Substrate):
    ...
    readiness_probe = readiness_probe(
        ...
        address="@@{ip_address}@@",
        delay_secs="0",
        credential=ref(BP_CRED_OpenStackKEYCredential),
    )
...
class OpenStackBlueprint(Blueprint):
    ...
    credentials = [BP_CRED_OpenStackKEYCredential]
