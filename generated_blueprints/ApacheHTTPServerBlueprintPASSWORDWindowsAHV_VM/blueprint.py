...
BP_CRED_ApacheHTTPServerPASSWORDCredential_PASSWORD = read_local_file(
    "BP_CRED_ApacheHTTPServerPASSWORDCredential_PASSWORD"
)

# Credentials
BP_CRED_ApacheHTTPServerPASSWORDCredential = basic_cred(
    "username",
    BP_CRED_ApacheHTTPServerPASSWORDCredential_PASSWORD,
    name="ApacheHTTPServerPASSWORDCredential",
    type="PASSWORD",
)


class ApacheHTTPServerService(Service):
    """
    ApacheHTTPServerService module
    Actions:
    ...
    def __create__():
        ...
        CalmTask.Exec.escript.py2(
            ...
            filename=os.path.join(
                "scripts",
                "Service_ApacheHTTPServerService_Action___create___Task_Task_0.py",
            ),
        )
        ...
        CalmTask.Exec.escript.py2(
            ...
            filename=os.path.join(
                "scripts",
                "Service_ApacheHTTPServerService_Action___create___Task_Task_1.py",
            ),
        )
        ...
        CalmTask.Exec.escript.py2(
            ...
            filename=os.path.join(
                "scripts",
                "Service_ApacheHTTPServerService_Action___create___Task_Task_2.py",
            ),
        )
    ...
    def __delete__():
        ...
        CalmTask.Exec.escript.py2(
            ...
            filename=os.path.join(
                "scripts",
                "Service_ApacheHTTPServerService_Action___delete___Task_Task_0.py",
            ),
        )
    ...
    def __start__():
        ...
        CalmTask.Exec.escript.py2(
            ...
            filename=os.path.join(
                "scripts",
                "Service_ApacheHTTPServerService_Action___start___Task_Task_0.py",
            ),
        )
        ...
        CalmTask.Exec.escript.py2(
            ...
            filename=os.path.join(
                "scripts",
                "Service_ApacheHTTPServerService_Action___start___Task_Task_1.py",
            ),
        )
    ...
    def __stop__():
        ...
        CalmTask.Exec.escript.py2(
            ...
            filename=os.path.join(
                "scripts",
                "Service_ApacheHTTPServerService_Action___stop___Task_Task_0.py",
            ),
        )
        ...
        CalmTask.Exec.escript.py2(
            ...
            filename=os.path.join(
                "scripts",
                "Service_ApacheHTTPServerService_Action___stop___Task_Task_1.py",
            ),
        )
    ...
    def __restart__():
        ...
        CalmTask.Exec.escript.py2(
            ...
            filename=os.path.join(
                "scripts",
                "Service_ApacheHTTPServerService_Action___restart___Task_Task_0.py",
            ),
        )
        ...
        CalmTask.Exec.escript.py2(
            ...
            filename=os.path.join(
                "scripts",
                "Service_ApacheHTTPServerService_Action___restart___Task_Task_1.py",
            ),
        )
        ...
        CalmTask.Exec.escript.py2(
            ...
            filename=os.path.join(
                "scripts",
                "Service_ApacheHTTPServerService_Action___restart___Task_Task_2.py",
            ),
        )


class ApacheHTTPServerWindowsAHV_VMSubstrateVmResources(AhvVmResources):
...
class ApacheHTTPServerWindowsAHV_VMSubstrate(Substrate):
    """
    Substrate module for ApacheHTTPServerWindowsAHV_VM. It contains following vm-confugration:
        Disks count: 3
        Nics count: 3
        CdRom count: 1
    provider_spec:
    ...
    provider_spec = ahv_vm(
        ...
        resources=ApacheHTTPServerWindowsAHV_VMSubstrateVmResources,
    )
    ...
    readiness_probe = readiness_probe(
        ...
        address="@@{ip_address}@@",
        delay_secs="0",
        credential=ref(BP_CRED_ApacheHTTPServerPASSWORDCredential),
    )
    ...
    def __pre_create__():
        ...
        CalmTask.Exec.escript.py2(
            ...
            filename=os.path.join(
                "scripts",
                "Substrate_ApacheHTTPServerWindowsAHV_VMSubstrate_Action___pre_create___Task_Task_0.py",
            ),
        )
        ...
        CalmTask.Exec.escript.py2(
            ...
            filename=os.path.join(
                "scripts",
                "Substrate_ApacheHTTPServerWindowsAHV_VMSubstrate_Action___pre_create___Task_Task_1.py",
            ),
        )
        ...
        CalmTask.Exec.escript.py2(
            ...
            filename=os.path.join(
                "scripts",
                "Substrate_ApacheHTTPServerWindowsAHV_VMSubstrate_Action___pre_create___Task_Task_2.py",
            ),
        )
    ...
    def __post_delete__():
        ...
        CalmTask.Exec.escript.py2(
            ...
            filename=os.path.join(
                "scripts",
                "Substrate_ApacheHTTPServerWindowsAHV_VMSubstrate_Action___post_delete___Task_Task_0.py",
            ),
        )


class ApacheHTTPServerPackage(Package):
    """
    Package module for ApacheHTTPServer
    Actions:
    ...
    services = [ref(ApacheHTTPServerService)]
    ...
    def __install__():
        ...
        CalmTask.Exec.escript.py2(
            ...
            filename=os.path.join(
                "scripts",
                "Package_ApacheHTTPServerPackage_Action___install___Task_Task_0.py",
            ),
        )
    ...
    def __uninstall__():
        ...
        CalmTask.Exec.escript.py2(
            ...
            filename=os.path.join(
                "scripts",
                "Package_ApacheHTTPServerPackage_Action___uninstall___Task_Task_0.py",
            ),
        )
        ...
        CalmTask.Exec.escript.py2(
            ...
            filename=os.path.join(
                "scripts",
                "Package_ApacheHTTPServerPackage_Action___uninstall___Task_Task_1.py",
            ),
        )


class ApacheHTTPServerDeployment(Deployment):
    """
    Deployment module for ApacheHTTPServer.
    ...
    packages = [ref(ApacheHTTPServerPackage)]
    substrate = ref(ApacheHTTPServerWindowsAHV_VMSubstrate)


class ApacheHTTPServerProfile(Profile):
    """
    Profile module for ApacheHTTPServer.
    ...
    deployments = [ApacheHTTPServerDeployment]


class ApacheHTTPServerBlueprint(Blueprint):
    """
    ApacheHTTPServerBlueprint module
    ...
    services = [ApacheHTTPServerService]
    packages = [ApacheHTTPServerPackage]
    substrates = [ApacheHTTPServerWindowsAHV_VMSubstrate]
    profiles = [ApacheHTTPServerProfile]
    credentials = [BP_CRED_ApacheHTTPServerPASSWORDCredential]
