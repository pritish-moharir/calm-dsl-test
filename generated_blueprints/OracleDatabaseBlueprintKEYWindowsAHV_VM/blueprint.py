...
BP_CRED_OracleDatabaseKEYCredential_KEY = read_local_file(
    "BP_CRED_OracleDatabaseKEYCredential_KEY"
)

# Credentials
BP_CRED_OracleDatabaseKEYCredential = basic_cred(
    "username",
    BP_CRED_OracleDatabaseKEYCredential_KEY,
    name="OracleDatabaseKEYCredential",
    type="KEY",
)
...
class OracleDatabaseWindowsAHV_VMSubstrate(Substrate):
    ...
    readiness_probe = readiness_probe(
        ...
        address="@@{ip_address}@@",
        delay_secs="0",
        credential=ref(BP_CRED_OracleDatabaseKEYCredential),
    )
...
class OracleDatabaseBlueprint(Blueprint):
    ...
    credentials = [BP_CRED_OracleDatabaseKEYCredential]
