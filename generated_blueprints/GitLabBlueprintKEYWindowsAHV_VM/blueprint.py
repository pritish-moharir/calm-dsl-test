...
BP_CRED_GitLabKEYCredential_KEY = read_local_file("BP_CRED_GitLabKEYCredential_KEY")

# Credentials
BP_CRED_GitLabKEYCredential = basic_cred(
    "username",
    BP_CRED_GitLabKEYCredential_KEY,
    name="GitLabKEYCredential",
    type="KEY",
)
...
class GitLabWindowsAHV_VMSubstrate(Substrate):
    ...
    readiness_probe = readiness_probe(
        ...
        address="@@{ip_address}@@",
        delay_secs="0",
        credential=ref(BP_CRED_GitLabKEYCredential),
    )
...
class GitLabBlueprint(Blueprint):
    ...
    credentials = [BP_CRED_GitLabKEYCredential]
