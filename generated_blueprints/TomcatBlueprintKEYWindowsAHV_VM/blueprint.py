...
BP_CRED_TomcatKEYCredential_KEY = read_local_file("BP_CRED_TomcatKEYCredential_KEY")

# Credentials
BP_CRED_TomcatKEYCredential = basic_cred(
    "username",
    BP_CRED_TomcatKEYCredential_KEY,
    name="TomcatKEYCredential",
    type="KEY",
)
...
class TomcatWindowsAHV_VMSubstrate(Substrate):
    ...
    readiness_probe = readiness_probe(
        ...
        address="@@{ip_address}@@",
        delay_secs="0",
        credential=ref(BP_CRED_TomcatKEYCredential),
    )
...
class TomcatBlueprint(Blueprint):
    ...
    credentials = [BP_CRED_TomcatKEYCredential]
