...
BP_CRED_PostgreSQLPASSWORDCredential_PASSWORD = read_local_file(
    "BP_CRED_PostgreSQLPASSWORDCredential_PASSWORD"
)

# Credentials
BP_CRED_PostgreSQLPASSWORDCredential = basic_cred(
    "username",
    BP_CRED_PostgreSQLPASSWORDCredential_PASSWORD,
    name="PostgreSQLPASSWORDCredential",
    type="PASSWORD",
)
...
class PostgreSQLService(Service):
    ...
    def __create__():
        ...
        CalmTask.Exec.escript.py2(
            ...
            filename=os.path.join(
                "scripts", "Service_PostgreSQLService_Action___create___Task_Task_0.py"
            ),
        )
        ...
        CalmTask.Exec.escript.py2(
            name="Task_1",
            filename=os.path.join(
                "scripts", "Service_PostgreSQLService_Action___create___Task_Task_1.py"
            ),
        )
        ...
        CalmTask.Exec.escript.py2(
            name="Task_2",
            filename=os.path.join(
                "scripts", "Service_PostgreSQLService_Action___create___Task_Task_2.py"
            ),
        )
    ...
    def __delete__():
        ...
        CalmTask.Exec.escript.py2(
            name="Task_0",
            filename=os.path.join(
                "scripts", "Service_PostgreSQLService_Action___delete___Task_Task_0.py"
            ),
        )
    ...
    def __start__():
        ...
        CalmTask.Exec.escript.py2(
            name="Task_0",
            filename=os.path.join(
                "scripts", "Service_PostgreSQLService_Action___start___Task_Task_0.py"
            ),
        )
        ...
        CalmTask.Exec.escript.py2(
            name="Task_1",
            filename=os.path.join(
                "scripts", "Service_PostgreSQLService_Action___start___Task_Task_1.py"
            ),
        )
    ...
    def __stop__():
        ...
        CalmTask.Exec.escript.py2(
            name="Task_0",
            filename=os.path.join(
                "scripts", "Service_PostgreSQLService_Action___stop___Task_Task_0.py"
            ),
        )
        ...
        CalmTask.Exec.escript.py2(
            name="Task_1",
            filename=os.path.join(
                "scripts", "Service_PostgreSQLService_Action___stop___Task_Task_1.py"
            ),
        )
    ...
    def __restart__():
        ...
        CalmTask.Exec.escript.py2(
            name="Task_0",
            filename=os.path.join(
                "scripts", "Service_PostgreSQLService_Action___restart___Task_Task_0.py"
            ),
        )
        ...
        CalmTask.Exec.escript.py2(
            name="Task_1",
            filename=os.path.join(
                "scripts", "Service_PostgreSQLService_Action___restart___Task_Task_1.py"
            ),
        )
        ...
        CalmTask.Exec.escript.py2(
            name="Task_2",
            filename=os.path.join(
                "scripts", "Service_PostgreSQLService_Action___restart___Task_Task_2.py"
            ),
        )


class PostgreSQLWindowsAHV_VMSubstrateVmResources(AhvVmResources):
...
class PostgreSQLWindowsAHV_VMSubstrate(Substrate):
    """
    Substrate module for PostgreSQLWindowsAHV_VM. It contains following vm-confugration:
        Disks count: 3
        Nics count: 3
        CdRom count: 1
    provider_spec:
    ...
    provider_spec = ahv_vm(
        ...
        resources=PostgreSQLWindowsAHV_VMSubstrateVmResources,
    )
    ...
    readiness_probe = readiness_probe(
        ...
        address="@@{ip_address}@@",
        delay_secs="0",
        credential=ref(BP_CRED_PostgreSQLPASSWORDCredential),
    )
    ...
    def __pre_create__():
        ...
        CalmTask.Exec.escript.py2(
            ...
            filename=os.path.join(
                "scripts",
                "Substrate_PostgreSQLWindowsAHV_VMSubstrate_Action___pre_create___Task_Task_0.py",
            ),
        )
        ...
        CalmTask.Exec.escript.py2(
            ...
            filename=os.path.join(
                "scripts",
                "Substrate_PostgreSQLWindowsAHV_VMSubstrate_Action___pre_create___Task_Task_1.py",
            ),
        )
        ...
        CalmTask.Exec.escript.py2(
            ...
            filename=os.path.join(
                "scripts",
                "Substrate_PostgreSQLWindowsAHV_VMSubstrate_Action___pre_create___Task_Task_2.py",
            ),
        )
    ...
    def __post_delete__():
        ...
        CalmTask.Exec.escript.py2(
            ...
            filename=os.path.join(
                "scripts",
                "Substrate_PostgreSQLWindowsAHV_VMSubstrate_Action___post_delete___Task_Task_0.py",
            ),
        )
...
class PostgreSQLPackage(Package):
    ...
    services = [ref(PostgreSQLService)]
    ...
    def __install__():
        ...
        CalmTask.Exec.escript.py2(
            name="Task_0",
            filename=os.path.join(
                "scripts", "Package_PostgreSQLPackage_Action___install___Task_Task_0.py"
            ),
        )
    ...
    def __uninstall__():
        ...
        CalmTask.Exec.escript.py2(
            ...
            filename=os.path.join(
                "scripts",
                "Package_PostgreSQLPackage_Action___uninstall___Task_Task_0.py",
            ),
        )
        ...
        CalmTask.Exec.escript.py2(
            ...
            filename=os.path.join(
                "scripts",
                "Package_PostgreSQLPackage_Action___uninstall___Task_Task_1.py",
            ),
        )


class PostgreSQLDeployment(Deployment):
    """
    Deployment module for PostgreSQL.
    ...
    packages = [ref(PostgreSQLPackage)]
    substrate = ref(PostgreSQLWindowsAHV_VMSubstrate)


class PostgreSQLProfile(Profile):
    """
    Profile module for PostgreSQL.
    ...
    deployments = [PostgreSQLDeployment]


class PostgreSQLBlueprint(Blueprint):
    """
    PostgreSQLBlueprint module
    ...
    packages = [PostgreSQLPackage]
    substrates = [PostgreSQLWindowsAHV_VMSubstrate]
    profiles = [PostgreSQLProfile]
    credentials = [BP_CRED_PostgreSQLPASSWORDCredential]
