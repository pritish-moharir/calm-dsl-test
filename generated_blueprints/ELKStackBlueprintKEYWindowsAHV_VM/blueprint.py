...
BP_CRED_ELKStackKEYCredential_KEY = read_local_file("BP_CRED_ELKStackKEYCredential_KEY")

# Credentials
BP_CRED_ELKStackKEYCredential = basic_cred(
    "username",
    BP_CRED_ELKStackKEYCredential_KEY,
    name="ELKStackKEYCredential",
    type="KEY",
)
...
class ELKStackWindowsAHV_VMSubstrate(Substrate):
    ...
    readiness_probe = readiness_probe(
        ...
        address="@@{ip_address}@@",
        delay_secs="0",
        credential=ref(BP_CRED_ELKStackKEYCredential),
    )
...
class ELKStackBlueprint(Blueprint):
    ...
    credentials = [BP_CRED_ELKStackKEYCredential]
