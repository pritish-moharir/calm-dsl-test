...
class CassandraLinuxAHV_VMSubstrateVmResources(AhvVmResources):
...
class CassandraLinuxAHV_VMSubstrate(Substrate):
    """
    Substrate module for CassandraLinuxAHV_VM. It contains following vm-confugration:
        Disks count: 3
        Nics count: 3
        CdRom count: 1
    provider_spec:
    ...
    provider_spec = ahv_vm(
        ...
        resources=CassandraLinuxAHV_VMSubstrateVmResources,
    )
    ...
    def __pre_create__():
        ...
        CalmTask.Exec.escript.py2(
            ...
            filename=os.path.join(
                "scripts",
                "Substrate_CassandraLinuxAHV_VMSubstrate_Action___pre_create___Task_Task_0.py",
            ),
        )
        ...
        CalmTask.Exec.escript.py2(
            ...
            filename=os.path.join(
                "scripts",
                "Substrate_CassandraLinuxAHV_VMSubstrate_Action___pre_create___Task_Task_1.py",
            ),
        )
        ...
        CalmTask.Exec.escript.py2(
            ...
            filename=os.path.join(
                "scripts",
                "Substrate_CassandraLinuxAHV_VMSubstrate_Action___pre_create___Task_Task_2.py",
            ),
        )
    ...
    def __post_delete__():
        ...
        CalmTask.Exec.escript.py2(
            ...
            filename=os.path.join(
                "scripts",
                "Substrate_CassandraLinuxAHV_VMSubstrate_Action___post_delete___Task_Task_0.py",
            ),
        )
...
class CassandraDeployment(Deployment):
    ...
    substrate = ref(CassandraLinuxAHV_VMSubstrate)
...
class CassandraBlueprint(Blueprint):
    ...
    substrates = [CassandraLinuxAHV_VMSubstrate]
