...
BP_CRED_MicrosoftSQLServerKEYCredential_KEY = read_local_file(
    "BP_CRED_MicrosoftSQLServerKEYCredential_KEY"
)

# Credentials
BP_CRED_MicrosoftSQLServerKEYCredential = basic_cred(
    "username",
    BP_CRED_MicrosoftSQLServerKEYCredential_KEY,
    name="MicrosoftSQLServerKEYCredential",
    type="KEY",
)
...
class MicrosoftSQLServerWindowsAHV_VMSubstrateVmResources(AhvVmResources):
...
class MicrosoftSQLServerWindowsAHV_VMSubstrate(Substrate):
    """
    Substrate module for MicrosoftSQLServerWindowsAHV_VM. It contains following vm-confugration:
        Disks count: 3
        Nics count: 3
        CdRom count: 1
    provider_spec:
    ...
    provider_spec = ahv_vm(
        ...
        resources=MicrosoftSQLServerWindowsAHV_VMSubstrateVmResources,
    )
    ...
    readiness_probe = readiness_probe(
        ...
        address="@@{ip_address}@@",
        delay_secs="0",
        credential=ref(BP_CRED_MicrosoftSQLServerKEYCredential),
    )
    ...
    def __pre_create__():
        ...
        CalmTask.Exec.escript.py2(
            ...
            filename=os.path.join(
                "scripts",
                "Substrate_MicrosoftSQLServerWindowsAHV_VMSubstrate_Action___pre_create___Task_Task_0.py",
            ),
        )
        ...
        CalmTask.Exec.escript.py2(
            ...
            filename=os.path.join(
                "scripts",
                "Substrate_MicrosoftSQLServerWindowsAHV_VMSubstrate_Action___pre_create___Task_Task_1.py",
            ),
        )
        ...
        CalmTask.Exec.escript.py2(
            ...
            filename=os.path.join(
                "scripts",
                "Substrate_MicrosoftSQLServerWindowsAHV_VMSubstrate_Action___pre_create___Task_Task_2.py",
            ),
        )
    ...
    def __post_delete__():
        ...
        CalmTask.Exec.escript.py2(
            ...
            filename=os.path.join(
                "scripts",
                "Substrate_MicrosoftSQLServerWindowsAHV_VMSubstrate_Action___post_delete___Task_Task_0.py",
            ),
        )
...
class MicrosoftSQLServerDeployment(Deployment):
    ...
    substrate = ref(MicrosoftSQLServerWindowsAHV_VMSubstrate)
...
class MicrosoftSQLServerBlueprint(Blueprint):
    ...
    substrates = [MicrosoftSQLServerWindowsAHV_VMSubstrate]
    profiles = [MicrosoftSQLServerProfile]
    credentials = [BP_CRED_MicrosoftSQLServerKEYCredential]
