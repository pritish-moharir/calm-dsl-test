...
BP_CRED_PrometheusKEYCredential_KEY = read_local_file(
    "BP_CRED_PrometheusKEYCredential_KEY"
)

# Credentials
BP_CRED_PrometheusKEYCredential = basic_cred(
    "username",
    BP_CRED_PrometheusKEYCredential_KEY,
    name="PrometheusKEYCredential",
    type="KEY",
)
...
class PrometheusWindowsAHV_VMSubstrate(Substrate):
    ...
    readiness_probe = readiness_probe(
        ...
        address="@@{ip_address}@@",
        delay_secs="0",
        credential=ref(BP_CRED_PrometheusKEYCredential),
    )
...
class PrometheusBlueprint(Blueprint):
    ...
    credentials = [BP_CRED_PrometheusKEYCredential]
