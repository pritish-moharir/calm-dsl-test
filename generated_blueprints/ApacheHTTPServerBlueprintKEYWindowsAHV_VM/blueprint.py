...
BP_CRED_ApacheHTTPServerKEYCredential_KEY = read_local_file(
    "BP_CRED_ApacheHTTPServerKEYCredential_KEY"
)

# Credentials
BP_CRED_ApacheHTTPServerKEYCredential = basic_cred(
    "username",
    BP_CRED_ApacheHTTPServerKEYCredential_KEY,
    name="ApacheHTTPServerKEYCredential",
    type="KEY",
)
...
class ApacheHTTPServerWindowsAHV_VMSubstrate(Substrate):
    ...
    readiness_probe = readiness_probe(
        ...
        address="@@{ip_address}@@",
        delay_secs="0",
        credential=ref(BP_CRED_ApacheHTTPServerKEYCredential),
    )
...
class ApacheHTTPServerBlueprint(Blueprint):
    ...
    credentials = [BP_CRED_ApacheHTTPServerKEYCredential]
