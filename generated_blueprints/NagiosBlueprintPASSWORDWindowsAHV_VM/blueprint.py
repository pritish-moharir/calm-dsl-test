...
BP_CRED_NagiosPASSWORDCredential_PASSWORD = read_local_file(
    "BP_CRED_NagiosPASSWORDCredential_PASSWORD"
)

# Credentials
BP_CRED_NagiosPASSWORDCredential = basic_cred(
    "username",
    BP_CRED_NagiosPASSWORDCredential_PASSWORD,
    name="NagiosPASSWORDCredential",
    type="PASSWORD",
)
...
class NagiosService(Service):
    ...
    def __create__():
        ...
        CalmTask.Exec.escript.py2(
            ...
            filename=os.path.join(
                "scripts", "Service_NagiosService_Action___create___Task_Task_0.py"
            ),
        )
        ...
        CalmTask.Exec.escript.py2(
            name="Task_1",
            filename=os.path.join(
                "scripts", "Service_NagiosService_Action___create___Task_Task_1.py"
            ),
        )
        ...
        CalmTask.Exec.escript.py2(
            name="Task_2",
            filename=os.path.join(
                "scripts", "Service_NagiosService_Action___create___Task_Task_2.py"
            ),
        )
    ...
    def __delete__():
        ...
        CalmTask.Exec.escript.py2(
            name="Task_0",
            filename=os.path.join(
                "scripts", "Service_NagiosService_Action___delete___Task_Task_0.py"
            ),
        )
    ...
    def __start__():
        ...
        CalmTask.Exec.escript.py2(
            name="Task_0",
            filename=os.path.join(
                "scripts", "Service_NagiosService_Action___start___Task_Task_0.py"
            ),
        )
        ...
        CalmTask.Exec.escript.py2(
            name="Task_1",
            filename=os.path.join(
                "scripts", "Service_NagiosService_Action___start___Task_Task_1.py"
            ),
        )
    ...
    def __stop__():
        ...
        CalmTask.Exec.escript.py2(
            name="Task_0",
            filename=os.path.join(
                "scripts", "Service_NagiosService_Action___stop___Task_Task_0.py"
            ),
        )
        ...
        CalmTask.Exec.escript.py2(
            name="Task_1",
            filename=os.path.join(
                "scripts", "Service_NagiosService_Action___stop___Task_Task_1.py"
            ),
        )
    ...
    def __restart__():
        ...
        CalmTask.Exec.escript.py2(
            name="Task_0",
            filename=os.path.join(
                "scripts", "Service_NagiosService_Action___restart___Task_Task_0.py"
            ),
        )
        ...
        CalmTask.Exec.escript.py2(
            name="Task_1",
            filename=os.path.join(
                "scripts", "Service_NagiosService_Action___restart___Task_Task_1.py"
            ),
        )
        ...
        CalmTask.Exec.escript.py2(
            name="Task_2",
            filename=os.path.join(
                "scripts", "Service_NagiosService_Action___restart___Task_Task_2.py"
            ),
        )


class NagiosWindowsAHV_VMSubstrateVmResources(AhvVmResources):
...
class NagiosWindowsAHV_VMSubstrate(Substrate):
    """
    Substrate module for NagiosWindowsAHV_VM. It contains following vm-confugration:
        Disks count: 3
        Nics count: 3
        CdRom count: 1
    provider_spec:
    ...
    provider_spec = ahv_vm(
        ...
        resources=NagiosWindowsAHV_VMSubstrateVmResources,
    )
    ...
    readiness_probe = readiness_probe(
        ...
        address="@@{ip_address}@@",
        delay_secs="0",
        credential=ref(BP_CRED_NagiosPASSWORDCredential),
    )
    ...
    def __pre_create__():
        ...
        CalmTask.Exec.escript.py2(
            ...
            filename=os.path.join(
                "scripts",
                "Substrate_NagiosWindowsAHV_VMSubstrate_Action___pre_create___Task_Task_0.py",
            ),
        )
        ...
        CalmTask.Exec.escript.py2(
            ...
            filename=os.path.join(
                "scripts",
                "Substrate_NagiosWindowsAHV_VMSubstrate_Action___pre_create___Task_Task_1.py",
            ),
        )
        ...
        CalmTask.Exec.escript.py2(
            ...
            filename=os.path.join(
                "scripts",
                "Substrate_NagiosWindowsAHV_VMSubstrate_Action___pre_create___Task_Task_2.py",
            ),
        )
    ...
    def __post_delete__():
        ...
        CalmTask.Exec.escript.py2(
            ...
            filename=os.path.join(
                "scripts",
                "Substrate_NagiosWindowsAHV_VMSubstrate_Action___post_delete___Task_Task_0.py",
            ),
        )


class NagiosPackage(Package):
    """
    Package module for Nagios
    Actions:
    ...
    def __install__():
        ...
        CalmTask.Exec.escript.py2(
            name="Task_0",
            filename=os.path.join(
                "scripts", "Package_NagiosPackage_Action___install___Task_Task_0.py"
            ),
        )
    ...
    def __uninstall__():
        ...
        CalmTask.Exec.escript.py2(
            name="Task_0",
            filename=os.path.join(
                "scripts", "Package_NagiosPackage_Action___uninstall___Task_Task_0.py"
            ),
        )
        ...
        CalmTask.Exec.escript.py2(
            name="Task_1",
            filename=os.path.join(
                "scripts", "Package_NagiosPackage_Action___uninstall___Task_Task_1.py"
            ),
        )


class NagiosDeployment(Deployment):
    """
    Deployment module for Nagios.
    ...
    packages = [ref(NagiosPackage)]
    substrate = ref(NagiosWindowsAHV_VMSubstrate)


class NagiosProfile(Profile):
    """
    Profile module for Nagios.
    ...
    deployments = [NagiosDeployment]


class NagiosBlueprint(Blueprint):
    """
    NagiosBlueprint module
    ...
    packages = [NagiosPackage]
    substrates = [NagiosWindowsAHV_VMSubstrate]
    profiles = [NagiosProfile]
    credentials = [BP_CRED_NagiosPASSWORDCredential]
