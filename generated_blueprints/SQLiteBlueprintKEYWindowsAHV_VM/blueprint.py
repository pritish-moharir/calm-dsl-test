...
BP_CRED_SQLiteKEYCredential_KEY = read_local_file("BP_CRED_SQLiteKEYCredential_KEY")

# Credentials
BP_CRED_SQLiteKEYCredential = basic_cred(
    "username",
    BP_CRED_SQLiteKEYCredential_KEY,
    name="SQLiteKEYCredential",
    type="KEY",
)
...
class SQLiteWindowsAHV_VMSubstrate(Substrate):
    ...
    readiness_probe = readiness_probe(
        ...
        address="@@{ip_address}@@",
        delay_secs="0",
        credential=ref(BP_CRED_SQLiteKEYCredential),
    )
...
class SQLiteBlueprint(Blueprint):
    ...
    credentials = [BP_CRED_SQLiteKEYCredential]
