...
BP_CRED_OpenStackPASSWORDCredential_PASSWORD = read_local_file(
    "BP_CRED_OpenStackPASSWORDCredential_PASSWORD"
)

# Credentials
BP_CRED_OpenStackPASSWORDCredential = basic_cred(
    "username",
    BP_CRED_OpenStackPASSWORDCredential_PASSWORD,
    name="OpenStackPASSWORDCredential",
    type="PASSWORD",
)
...
class OpenStackService(Service):
    ...
    def __create__():
        ...
        CalmTask.Exec.escript.py2(
            ...
            filename=os.path.join(
                "scripts", "Service_OpenStackService_Action___create___Task_Task_0.py"
            ),
        )
        ...
        CalmTask.Exec.escript.py2(
            name="Task_1",
            filename=os.path.join(
                "scripts", "Service_OpenStackService_Action___create___Task_Task_1.py"
            ),
        )
        ...
        CalmTask.Exec.escript.py2(
            name="Task_2",
            filename=os.path.join(
                "scripts", "Service_OpenStackService_Action___create___Task_Task_2.py"
            ),
        )
    ...
    def __delete__():
        ...
        CalmTask.Exec.escript.py2(
            name="Task_0",
            filename=os.path.join(
                "scripts", "Service_OpenStackService_Action___delete___Task_Task_0.py"
            ),
        )
    ...
    def __start__():
        ...
        CalmTask.Exec.escript.py2(
            name="Task_0",
            filename=os.path.join(
                "scripts", "Service_OpenStackService_Action___start___Task_Task_0.py"
            ),
        )
        ...
        CalmTask.Exec.escript.py2(
            name="Task_1",
            filename=os.path.join(
                "scripts", "Service_OpenStackService_Action___start___Task_Task_1.py"
            ),
        )
    ...
    def __stop__():
        ...
        CalmTask.Exec.escript.py2(
            name="Task_0",
            filename=os.path.join(
                "scripts", "Service_OpenStackService_Action___stop___Task_Task_0.py"
            ),
        )
        ...
        CalmTask.Exec.escript.py2(
            name="Task_1",
            filename=os.path.join(
                "scripts", "Service_OpenStackService_Action___stop___Task_Task_1.py"
            ),
        )
    ...
    def __restart__():
        ...
        CalmTask.Exec.escript.py2(
            name="Task_0",
            filename=os.path.join(
                "scripts", "Service_OpenStackService_Action___restart___Task_Task_0.py"
            ),
        )
        ...
        CalmTask.Exec.escript.py2(
            name="Task_1",
            filename=os.path.join(
                "scripts", "Service_OpenStackService_Action___restart___Task_Task_1.py"
            ),
        )
        ...
        CalmTask.Exec.escript.py2(
            name="Task_2",
            filename=os.path.join(
                "scripts", "Service_OpenStackService_Action___restart___Task_Task_2.py"
            ),
        )


class OpenStackWindowsAHV_VMSubstrateVmResources(AhvVmResources):
...
class OpenStackWindowsAHV_VMSubstrate(Substrate):
    """
    Substrate module for OpenStackWindowsAHV_VM. It contains following vm-confugration:
        Disks count: 3
        Nics count: 3
        CdRom count: 1
    provider_spec:
    ...
    provider_spec = ahv_vm(
        ...
        resources=OpenStackWindowsAHV_VMSubstrateVmResources,
    )
    ...
    readiness_probe = readiness_probe(
        ...
        address="@@{ip_address}@@",
        delay_secs="0",
        credential=ref(BP_CRED_OpenStackPASSWORDCredential),
    )
    ...
    def __pre_create__():
        ...
        CalmTask.Exec.escript.py2(
            ...
            filename=os.path.join(
                "scripts",
                "Substrate_OpenStackWindowsAHV_VMSubstrate_Action___pre_create___Task_Task_0.py",
            ),
        )
        ...
        CalmTask.Exec.escript.py2(
            ...
            filename=os.path.join(
                "scripts",
                "Substrate_OpenStackWindowsAHV_VMSubstrate_Action___pre_create___Task_Task_1.py",
            ),
        )
        ...
        CalmTask.Exec.escript.py2(
            ...
            filename=os.path.join(
                "scripts",
                "Substrate_OpenStackWindowsAHV_VMSubstrate_Action___pre_create___Task_Task_2.py",
            ),
        )
    ...
    def __post_delete__():
        ...
        CalmTask.Exec.escript.py2(
            ...
            filename=os.path.join(
                "scripts",
                "Substrate_OpenStackWindowsAHV_VMSubstrate_Action___post_delete___Task_Task_0.py",
            ),
        )


class OpenStackPackage(Package):
    """
    Package module for OpenStack
    Actions:
    ...
    def __install__():
        ...
        CalmTask.Exec.escript.py2(
            name="Task_0",
            filename=os.path.join(
                "scripts", "Package_OpenStackPackage_Action___install___Task_Task_0.py"
            ),
        )
    ...
    def __uninstall__():
        ...
        CalmTask.Exec.escript.py2(
            ...
            filename=os.path.join(
                "scripts",
                "Package_OpenStackPackage_Action___uninstall___Task_Task_0.py",
            ),
        )
        ...
        CalmTask.Exec.escript.py2(
            ...
            filename=os.path.join(
                "scripts",
                "Package_OpenStackPackage_Action___uninstall___Task_Task_1.py",
            ),
        )
...
class OpenStackDeployment(Deployment):
    """
    Deployment module for OpenStack.
    ...
    packages = [ref(OpenStackPackage)]
    substrate = ref(OpenStackWindowsAHV_VMSubstrate)


class OpenStackProfile(Profile):
    """
    Profile module for OpenStack.
    ...
    deployments = [OpenStackDeployment]


class OpenStackBlueprint(Blueprint):
    """
    OpenStackBlueprint module
    ...
    packages = [OpenStackPackage]
    substrates = [OpenStackWindowsAHV_VMSubstrate]
    profiles = [OpenStackProfile]
    credentials = [BP_CRED_OpenStackPASSWORDCredential]
