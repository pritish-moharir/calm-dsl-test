...
BP_CRED_SQLitePASSWORDCredential_PASSWORD = read_local_file(
    "BP_CRED_SQLitePASSWORDCredential_PASSWORD"
)

# Credentials
BP_CRED_SQLitePASSWORDCredential = basic_cred(
    "username",
    BP_CRED_SQLitePASSWORDCredential_PASSWORD,
    name="SQLitePASSWORDCredential",
    type="PASSWORD",
)
...
class SQLiteService(Service):
    ...
    def __create__():
        ...
        CalmTask.Exec.escript.py2(
            ...
            filename=os.path.join(
                "scripts", "Service_SQLiteService_Action___create___Task_Task_0.py"
            ),
        )
        ...
        CalmTask.Exec.escript.py2(
            name="Task_1",
            filename=os.path.join(
                "scripts", "Service_SQLiteService_Action___create___Task_Task_1.py"
            ),
        )
        ...
        CalmTask.Exec.escript.py2(
            name="Task_2",
            filename=os.path.join(
                "scripts", "Service_SQLiteService_Action___create___Task_Task_2.py"
            ),
        )
    ...
    def __delete__():
        ...
        CalmTask.Exec.escript.py2(
            name="Task_0",
            filename=os.path.join(
                "scripts", "Service_SQLiteService_Action___delete___Task_Task_0.py"
            ),
        )
    ...
    def __start__():
        ...
        CalmTask.Exec.escript.py2(
            name="Task_0",
            filename=os.path.join(
                "scripts", "Service_SQLiteService_Action___start___Task_Task_0.py"
            ),
        )
        ...
        CalmTask.Exec.escript.py2(
            name="Task_1",
            filename=os.path.join(
                "scripts", "Service_SQLiteService_Action___start___Task_Task_1.py"
            ),
        )
    ...
    def __stop__():
        ...
        CalmTask.Exec.escript.py2(
            name="Task_0",
            filename=os.path.join(
                "scripts", "Service_SQLiteService_Action___stop___Task_Task_0.py"
            ),
        )
        ...
        CalmTask.Exec.escript.py2(
            name="Task_1",
            filename=os.path.join(
                "scripts", "Service_SQLiteService_Action___stop___Task_Task_1.py"
            ),
        )
    ...
    def __restart__():
        ...
        CalmTask.Exec.escript.py2(
            name="Task_0",
            filename=os.path.join(
                "scripts", "Service_SQLiteService_Action___restart___Task_Task_0.py"
            ),
        )
        ...
        CalmTask.Exec.escript.py2(
            name="Task_1",
            filename=os.path.join(
                "scripts", "Service_SQLiteService_Action___restart___Task_Task_1.py"
            ),
        )
        ...
        CalmTask.Exec.escript.py2(
            name="Task_2",
            filename=os.path.join(
                "scripts", "Service_SQLiteService_Action___restart___Task_Task_2.py"
            ),
        )


class SQLiteWindowsAHV_VMSubstrateVmResources(AhvVmResources):
...
class SQLiteWindowsAHV_VMSubstrate(Substrate):
    """
    Substrate module for SQLiteWindowsAHV_VM. It contains following vm-confugration:
        Disks count: 3
        Nics count: 3
        CdRom count: 1
    provider_spec:
    ...
    provider_spec = ahv_vm(
        ...
        resources=SQLiteWindowsAHV_VMSubstrateVmResources,
    )
    ...
    readiness_probe = readiness_probe(
        ...
        address="@@{ip_address}@@",
        delay_secs="0",
        credential=ref(BP_CRED_SQLitePASSWORDCredential),
    )
    ...
    def __pre_create__():
        ...
        CalmTask.Exec.escript.py2(
            ...
            filename=os.path.join(
                "scripts",
                "Substrate_SQLiteWindowsAHV_VMSubstrate_Action___pre_create___Task_Task_0.py",
            ),
        )
        ...
        CalmTask.Exec.escript.py2(
            ...
            filename=os.path.join(
                "scripts",
                "Substrate_SQLiteWindowsAHV_VMSubstrate_Action___pre_create___Task_Task_1.py",
            ),
        )
        ...
        CalmTask.Exec.escript.py2(
            ...
            filename=os.path.join(
                "scripts",
                "Substrate_SQLiteWindowsAHV_VMSubstrate_Action___pre_create___Task_Task_2.py",
            ),
        )
    ...
    def __post_delete__():
        ...
        CalmTask.Exec.escript.py2(
            ...
            filename=os.path.join(
                "scripts",
                "Substrate_SQLiteWindowsAHV_VMSubstrate_Action___post_delete___Task_Task_0.py",
            ),
        )
...
class SQLitePackage(Package):
    ...
    def __install__():
        ...
        CalmTask.Exec.escript.py2(
            name="Task_0",
            filename=os.path.join(
                "scripts", "Package_SQLitePackage_Action___install___Task_Task_0.py"
            ),
        )
    ...
    def __uninstall__():
        ...
        CalmTask.Exec.escript.py2(
            name="Task_0",
            filename=os.path.join(
                "scripts", "Package_SQLitePackage_Action___uninstall___Task_Task_0.py"
            ),
        )
        ...
        CalmTask.Exec.escript.py2(
            name="Task_1",
            filename=os.path.join(
                "scripts", "Package_SQLitePackage_Action___uninstall___Task_Task_1.py"
            ),
        )


class SQLiteDeployment(Deployment):
    """
    Deployment module for SQLite.
    ...
    packages = [ref(SQLitePackage)]
    substrate = ref(SQLiteWindowsAHV_VMSubstrate)


class SQLiteProfile(Profile):
    """
    Profile module for SQLite.
    ...
    deployments = [SQLiteDeployment]


class SQLiteBlueprint(Blueprint):
    """
    SQLiteBlueprint module
    ...
    packages = [SQLitePackage]
    substrates = [SQLiteWindowsAHV_VMSubstrate]
    profiles = [SQLiteProfile]
    credentials = [BP_CRED_SQLitePASSWORDCredential]
