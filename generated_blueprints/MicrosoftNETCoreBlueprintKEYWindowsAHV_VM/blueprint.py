...
BP_CRED_MicrosoftNETCoreKEYCredential_KEY = read_local_file(
    "BP_CRED_MicrosoftNETCoreKEYCredential_KEY"
)

# Credentials
BP_CRED_MicrosoftNETCoreKEYCredential = basic_cred(
    "username",
    BP_CRED_MicrosoftNETCoreKEYCredential_KEY,
    name="MicrosoftNETCoreKEYCredential",
    type="KEY",
)
...
class MicrosoftNETCoreWindowsAHV_VMSubstrate(Substrate):
    ...
    readiness_probe = readiness_probe(
        ...
        address="@@{ip_address}@@",
        delay_secs="0",
        credential=ref(BP_CRED_MicrosoftNETCoreKEYCredential),
    )
...
class MicrosoftNETCoreBlueprint(Blueprint):
    ...
    credentials = [BP_CRED_MicrosoftNETCoreKEYCredential]
