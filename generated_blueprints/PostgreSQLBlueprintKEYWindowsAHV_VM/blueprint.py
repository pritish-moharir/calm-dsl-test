...
BP_CRED_PostgreSQLKEYCredential_KEY = read_local_file(
    "BP_CRED_PostgreSQLKEYCredential_KEY"
)

# Credentials
BP_CRED_PostgreSQLKEYCredential = basic_cred(
    "username",
    BP_CRED_PostgreSQLKEYCredential_KEY,
    name="PostgreSQLKEYCredential",
    type="KEY",
)
...
class PostgreSQLWindowsAHV_VMSubstrate(Substrate):
    ...
    readiness_probe = readiness_probe(
        ...
        address="@@{ip_address}@@",
        delay_secs="0",
        credential=ref(BP_CRED_PostgreSQLKEYCredential),
    )
...
class PostgreSQLBlueprint(Blueprint):
    ...
    credentials = [BP_CRED_PostgreSQLKEYCredential]
