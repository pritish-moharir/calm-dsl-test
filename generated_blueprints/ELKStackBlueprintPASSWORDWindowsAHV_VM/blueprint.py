...
BP_CRED_ELKStackPASSWORDCredential_PASSWORD = read_local_file(
    "BP_CRED_ELKStackPASSWORDCredential_PASSWORD"
)

# Credentials
BP_CRED_ELKStackPASSWORDCredential = basic_cred(
    "username",
    BP_CRED_ELKStackPASSWORDCredential_PASSWORD,
    name="ELKStackPASSWORDCredential",
    type="PASSWORD",
)


class ELKStackService(Service):
    """
    ELKStackService module
    Actions:
    ...
    def __create__():
        ...
        CalmTask.Exec.escript.py2(
            ...
            filename=os.path.join(
                "scripts", "Service_ELKStackService_Action___create___Task_Task_0.py"
            ),
        )
        ...
        CalmTask.Exec.escript.py2(
            name="Task_1",
            filename=os.path.join(
                "scripts", "Service_ELKStackService_Action___create___Task_Task_1.py"
            ),
        )
        ...
        CalmTask.Exec.escript.py2(
            name="Task_2",
            filename=os.path.join(
                "scripts", "Service_ELKStackService_Action___create___Task_Task_2.py"
            ),
        )
    ...
    def __delete__():
        ...
        CalmTask.Exec.escript.py2(
            name="Task_0",
            filename=os.path.join(
                "scripts", "Service_ELKStackService_Action___delete___Task_Task_0.py"
            ),
        )
    ...
    def __start__():
        ...
        CalmTask.Exec.escript.py2(
            name="Task_0",
            filename=os.path.join(
                "scripts", "Service_ELKStackService_Action___start___Task_Task_0.py"
            ),
        )
        ...
        CalmTask.Exec.escript.py2(
            name="Task_1",
            filename=os.path.join(
                "scripts", "Service_ELKStackService_Action___start___Task_Task_1.py"
            ),
        )
    ...
    def __stop__():
        ...
        CalmTask.Exec.escript.py2(
            name="Task_0",
            filename=os.path.join(
                "scripts", "Service_ELKStackService_Action___stop___Task_Task_0.py"
            ),
        )
        ...
        CalmTask.Exec.escript.py2(
            name="Task_1",
            filename=os.path.join(
                "scripts", "Service_ELKStackService_Action___stop___Task_Task_1.py"
            ),
        )
    ...
    def __restart__():
        ...
        CalmTask.Exec.escript.py2(
            name="Task_0",
            filename=os.path.join(
                "scripts", "Service_ELKStackService_Action___restart___Task_Task_0.py"
            ),
        )
        ...
        CalmTask.Exec.escript.py2(
            name="Task_1",
            filename=os.path.join(
                "scripts", "Service_ELKStackService_Action___restart___Task_Task_1.py"
            ),
        )
        ...
        CalmTask.Exec.escript.py2(
            name="Task_2",
            filename=os.path.join(
                "scripts", "Service_ELKStackService_Action___restart___Task_Task_2.py"
            ),
        )


class ELKStackWindowsAHV_VMSubstrateVmResources(AhvVmResources):
...
class ELKStackWindowsAHV_VMSubstrate(Substrate):
    """
    Substrate module for ELKStackWindowsAHV_VM. It contains following vm-confugration:
        Disks count: 3
        Nics count: 3
        CdRom count: 1
    provider_spec:
    ...
    provider_spec = ahv_vm(
        ...
        resources=ELKStackWindowsAHV_VMSubstrateVmResources,
    )
    ...
    readiness_probe = readiness_probe(
        ...
        address="@@{ip_address}@@",
        delay_secs="0",
        credential=ref(BP_CRED_ELKStackPASSWORDCredential),
    )
    ...
    def __pre_create__():
        ...
        CalmTask.Exec.escript.py2(
            ...
            filename=os.path.join(
                "scripts",
                "Substrate_ELKStackWindowsAHV_VMSubstrate_Action___pre_create___Task_Task_0.py",
            ),
        )
        ...
        CalmTask.Exec.escript.py2(
            ...
            filename=os.path.join(
                "scripts",
                "Substrate_ELKStackWindowsAHV_VMSubstrate_Action___pre_create___Task_Task_1.py",
            ),
        )
        ...
        CalmTask.Exec.escript.py2(
            ...
            filename=os.path.join(
                "scripts",
                "Substrate_ELKStackWindowsAHV_VMSubstrate_Action___pre_create___Task_Task_2.py",
            ),
        )
    ...
    def __post_delete__():
        ...
        CalmTask.Exec.escript.py2(
            ...
            filename=os.path.join(
                "scripts",
                "Substrate_ELKStackWindowsAHV_VMSubstrate_Action___post_delete___Task_Task_0.py",
            ),
        )


class ELKStackPackage(Package):
    """
    Package module for ELKStack
    Actions:
    ...
    def __install__():
        ...
        CalmTask.Exec.escript.py2(
            name="Task_0",
            filename=os.path.join(
                "scripts", "Package_ELKStackPackage_Action___install___Task_Task_0.py"
            ),
        )
    ...
    def __uninstall__():
        ...
        CalmTask.Exec.escript.py2(
            name="Task_0",
            filename=os.path.join(
                "scripts", "Package_ELKStackPackage_Action___uninstall___Task_Task_0.py"
            ),
        )
        ...
        CalmTask.Exec.escript.py2(
            name="Task_1",
            filename=os.path.join(
                "scripts", "Package_ELKStackPackage_Action___uninstall___Task_Task_1.py"
            ),
        )


class ELKStackDeployment(Deployment):
    """
    Deployment module for ELKStack.
    ...
    packages = [ref(ELKStackPackage)]
    substrate = ref(ELKStackWindowsAHV_VMSubstrate)


class ELKStackProfile(Profile):
    """
    Profile module for ELKStack.
    ...
    deployments = [ELKStackDeployment]


class ELKStackBlueprint(Blueprint):
    """
    ELKStackBlueprint module
    ...
    services = [ELKStackService]
    packages = [ELKStackPackage]
    substrates = [ELKStackWindowsAHV_VMSubstrate]
    profiles = [ELKStackProfile]
    credentials = [BP_CRED_ELKStackPASSWORDCredential]
