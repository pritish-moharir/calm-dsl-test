...
BP_CRED_NagiosKEYCredential_KEY = read_local_file("BP_CRED_NagiosKEYCredential_KEY")

# Credentials
BP_CRED_NagiosKEYCredential = basic_cred(
    "username",
    BP_CRED_NagiosKEYCredential_KEY,
    name="NagiosKEYCredential",
    type="KEY",
)
...
class NagiosWindowsAHV_VMSubstrate(Substrate):
    ...
    readiness_probe = readiness_probe(
        ...
        address="@@{ip_address}@@",
        delay_secs="0",
        credential=ref(BP_CRED_NagiosKEYCredential),
    )
...
class NagiosBlueprint(Blueprint):
    ...
    credentials = [BP_CRED_NagiosKEYCredential]
