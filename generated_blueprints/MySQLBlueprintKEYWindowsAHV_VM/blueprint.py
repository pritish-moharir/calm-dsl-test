...
BP_CRED_MySQLKEYCredential_KEY = read_local_file("BP_CRED_MySQLKEYCredential_KEY")

# Credentials
BP_CRED_MySQLKEYCredential = basic_cred(
    "username",
    BP_CRED_MySQLKEYCredential_KEY,
    name="MySQLKEYCredential",
    type="KEY",
)
...
class MySQLWindowsAHV_VMSubstrate(Substrate):
    ...
    readiness_probe = readiness_probe(
        ...
        address="@@{ip_address}@@",
        delay_secs="0",
        credential=ref(BP_CRED_MySQLKEYCredential),
    )
...
class MySQLBlueprint(Blueprint):
    ...
    credentials = [BP_CRED_MySQLKEYCredential]
