...
class TomcatLinuxAHV_VMSubstrateVmResources(AhvVmResources):
...
class TomcatLinuxAHV_VMSubstrate(Substrate):
    """
    Substrate module for TomcatLinuxAHV_VM. It contains following vm-confugration:
        Disks count: 3
        Nics count: 3
        CdRom count: 1
    provider_spec:
    ...
    provider_spec = ahv_vm(
        ...
        resources=TomcatLinuxAHV_VMSubstrateVmResources,
    )
    ...
    def __pre_create__():
        ...
        CalmTask.Exec.escript.py2(
            ...
            filename=os.path.join(
                "scripts",
                "Substrate_TomcatLinuxAHV_VMSubstrate_Action___pre_create___Task_Task_0.py",
            ),
        )
        ...
        CalmTask.Exec.escript.py2(
            ...
            filename=os.path.join(
                "scripts",
                "Substrate_TomcatLinuxAHV_VMSubstrate_Action___pre_create___Task_Task_1.py",
            ),
        )
        ...
        CalmTask.Exec.escript.py2(
            ...
            filename=os.path.join(
                "scripts",
                "Substrate_TomcatLinuxAHV_VMSubstrate_Action___pre_create___Task_Task_2.py",
            ),
        )
    ...
    def __post_delete__():
        ...
        CalmTask.Exec.escript.py2(
            ...
            filename=os.path.join(
                "scripts",
                "Substrate_TomcatLinuxAHV_VMSubstrate_Action___post_delete___Task_Task_0.py",
            ),
        )
...
class TomcatDeployment(Deployment):
    ...
    substrate = ref(TomcatLinuxAHV_VMSubstrate)
...
class TomcatBlueprint(Blueprint):
    ...
    substrates = [TomcatLinuxAHV_VMSubstrate]
