...
BP_CRED_KafkaKEYCredential_KEY = read_local_file("BP_CRED_KafkaKEYCredential_KEY")

# Credentials
BP_CRED_KafkaKEYCredential = basic_cred(
    "username",
    BP_CRED_KafkaKEYCredential_KEY,
    name="KafkaKEYCredential",
    type="KEY",
)
...
class KafkaWindowsAHV_VMSubstrate(Substrate):
    ...
    readiness_probe = readiness_probe(
        ...
        address="@@{ip_address}@@",
        delay_secs="0",
        credential=ref(BP_CRED_KafkaKEYCredential),
    )
...
class KafkaBlueprint(Blueprint):
    ...
    credentials = [BP_CRED_KafkaKEYCredential]
