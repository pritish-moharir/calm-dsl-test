...
BP_CRED_Neo4jKEYCredential_KEY = read_local_file("BP_CRED_Neo4jKEYCredential_KEY")

# Credentials
BP_CRED_Neo4jKEYCredential = basic_cred(
    "username",
    BP_CRED_Neo4jKEYCredential_KEY,
    name="Neo4jKEYCredential",
    type="KEY",
)
...
class Neo4jWindowsAHV_VMSubstrate(Substrate):
    ...
    readiness_probe = readiness_probe(
        ...
        address="@@{ip_address}@@",
        delay_secs="0",
        credential=ref(BP_CRED_Neo4jKEYCredential),
    )
...
class Neo4jBlueprint(Blueprint):
    ...
    credentials = [BP_CRED_Neo4jKEYCredential]
